...
public class ProjectileTrajectory {
  ...
  //   // Create a sphere projectile: 6" diameter, 0.5 lbs, 100 ft/s at 45 degrees, 5 feet initial
  //   // height
  //   ProjectileTrajectory trajectory = ProjectileTrajectory.createSphere(5, 100, 45, 6, 0.5);
  ...
  //   System.out.println("Diameter: 6 inches");
  //   System.out.println(
  //       "Mass: 0.5 lbs (" + String.format("%.5f", trajectory.getMassPounds()) + " lbs)");
  //   System.out.println("Initial Speed: " + trajectory.getSpeed() + " ft/s");
  //   System.out.println(
  //       "Launch Angle: " + String.format("%.1f", trajectory.getAngleDegrees()) + "°");
  //   System.out.println("Initial Height: " + trajectory.getHeight() + " ft");
  //   System.out.println(
  //       "Elevation: 7000 ft (Air Density: "
  //           + String.format("%.6f", trajectory.getAirDensity())
  //           + " slugs/ft³)");
  //   System.out.println();
  ...
  //   System.out.println(
  //       "Time to Max Height: " + String.format("%.2f", trajectory.getMaxHeightTime()) + " s");
  //   System.out.println("Range: " + String.format("%.2f", trajectory.getRange()) + " ft");
  //   System.out.println("Impact Time: " + String.format("%.2f", trajectory.getImpactTime()) + " s");
  //   System.out.println(
  //       "Impact Speed: " + String.format("%.2f", trajectory.getImpactSpeed()) + " ft/s");

  //   double[] impactVel = trajectory.getImpactVelocity();
  //   System.out.println(
  //       "Impact Velocity (vx, vy): ("
  //           + String.format("%.2f", impactVel[0])
  //           + ", "
  //           + String.format("%.2f", impactVel[1])
  //           + ") ft/s");
  //   System.out.println();
  //   System.out.println("=== Sample Trajectory Points ===");
  //   System.out.printf("%-10s %-12s %-12s %-15s%n", "Time (s)", "X (ft)", "Y (ft)", "Speed (ft/s)");
  //   System.out.println("-".repeat(50));

  //   int step = Math.max(1, points.size() / 10);
  //   for (int i = 0; i < points.size(); i += step) {
  //     TrajectoryPoint point = points.get(i);
  //     System.out.printf(
  //         "%-10.2f %-12.2f %-12.2f %-15.2f%n", point.time, point.x, point.y, point.speed);
  //   }
  // }
}
